...
class DatabaseController {
    ...
    async selectDatabase() {
        ...
        try {
            const dbPath
            // dashboard-init.js - Script to be included in dashboard.html
// This script initializes the dashboard components and handles authentication
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        if (window.electronAPI) {
            ...
            document.getElementById('dbStatus').textContent = 'API Electrona nie jest dostępne';
        }
        ...
        document.getElementById('refreshCommandsBtn').addEventListener('click', async () => {
            try {
                const commands = await getCommands();
                renderCommandsUI(commands);
